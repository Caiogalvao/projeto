class CasasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @casa.save
        format.html { redirect_to @casa, notice: 'Criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @casa.update(casa_params)
        format.html { redirect_to @casa, notice: 'Atualizado com sucesso.' }
  ...
  def destroy
    @casa.destroy
    respond_to do |format|
      format.html { redirect_to casas_url, notice: 'Deletado com sucesso.' }
  ...
  private
    ...
    def casa_params
      params.require(:casa).permit(:name, :age.to_s)
    end
end
